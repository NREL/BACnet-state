...
# KnownDevice.all.each do |kd|
  ...
  polltask = Poll.new(remote_device,local_device,bacnet.getDefaultWriters, oids)
  ...
  exec.getScheduledSvc.scheduleWithFixedDelay(pollone, polltask.poll_delay, polltask.poll_rate, TimeUnit::SECONDS)
